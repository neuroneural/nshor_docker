...
PATH_FILE=/data/users2/jwardell1/nshor_docker/bsnip-project/BSNIP/Boston/paths
touch ${PATH_FILE}
...
do
	...
	OUTPUT_DIRECTORY=/data/users2/jwardell1/nshor_docker/bsnip-project/BSNIP/Boston
