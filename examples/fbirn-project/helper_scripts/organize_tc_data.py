...
labels_dict = np.load('/data/users2/jwardell1/nshor_docker/examples/fbirn-project/FBIRN/labels.npy',allow_pickle='TRUE').item()
paths_string = '/data/users2/jwardell1/nshor_docker/examples/fbirn-project/FBIRN/time_courses_files.txt'
