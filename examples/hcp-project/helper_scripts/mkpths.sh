...
PARAMS_DIRECTORY=/data/users2/jwardell1/nshor_docker/examples/hcp-project
num_subs=`ls $DATA_DIRECTORY | wc -l`
IFS=$'\n' sub_ids=($(cat /data/users2/jwardell1/nshor_docker/examples/hcp-project/HCP/subjects.txt))
PATH_FILE=/data/users2/jwardell1/nshor_docker/examples/hcp-project/HCP/paths
touch ${PATH_FILE}
