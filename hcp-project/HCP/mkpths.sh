...
do
	...
	echo "${DATA_DIRECTORY}/${subjectID}/unprocessed/3T/T1w_MPR1/${subjectID}_3T_SpinEchoFieldMap_LR.nii.gz" >> $PATH_FILE
	echo "${DATA_DIRECTORY}/${subjectID}/unprocessed/3T/T1w_MPR1/${subjectID}_3T_SpinEchoFieldMap_RL.nii.gz" >> $PATH_FILE
	echo "${DATA_DIRECTORY}/${subjectID}/unprocessed/3T/T1w_MPR1/${subjectID}_3T_BIAS_32CH.nii.gz" >> $PATH_FILE
