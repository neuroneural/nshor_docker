...
function submit_hcpnm() {
	...
	bash /data/users2/jwardell1/nshor_docker/examples/hcpnm-project/submit.sh
	echo "hcp neuromark submitted"
}



function submit_ds004078() {
	######################################################################################################
	# ds004078
	# 1. Copies script to make paths file and output directory into project dir
	# 2. Copies textfile list of subjects into project dir
